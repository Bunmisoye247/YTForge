...
const fieldClasses =
  "w-full rounded-md border border-[--color-border] bg-[--color-bg] px-3 py-2 text-sm text-[--color-text] outline-none focus:border-[--color-accent] disabled:opacity-50 dark:border-[--color-border-dark] dark:bg-[--color-bg-dark] dark:text-[--color-text-dark]";
