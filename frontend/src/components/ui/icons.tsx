...
/** Shared line-icon set for the sidebar nav and pipeline rail — same icon
 * is reused in both places for a given domain concept (e.g. Scripts nav
 * item and the Script pipeline stage), so keep this the single source. */
...
export function IconStoryboards(props: IconProps) {
  return (
    <svg {...base(props)}>
